...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
      ...
      <span id="close" class="closeBtn close " data-dismiss="modal" >&times;</span>
	   ...
	   <div class="main">
		...
		<div class="secondPart1">
			...
			<input type="text" name="phoneNo" minlength="10" maxlength="10" placeholder="Phone No*" class="E-mail input"   required >
		...
		<div class="carousel-inner">
			...
			<form action = 'package_detail.php' method = 'POST'>
				...
				<div class="carousel-caption d-none d-md-block">
    				...
    				<p class="description animated bounceInRight">
    					Enjoy your best days in Goa with sunshine and beach.
    				</p>
    				<button class="StartTour animated bounceInUp ">Start Tour</button>
    			    </div>
  				</div>
			...
			<div class="location-search">
				...
				<div class="location-search-content">
					...
					<?php
						...
						$stateOption = "SELECT DISTINCT State from package_info";

						$stateOptionRs = mysqli_query($con,$stateOption);

					 	while ($stateOptionRows = mysqli_fetch_array($stateOptionRs)) {

					 ?>
						<option value="<?php echo $stateOptionRows['State']; ?>"><?php echo $stateOptionRows['State']; ?></option>
			...
			<div class="hotel-search">
				...
				<div class="hotel-search-content">
					...
					<?php
						...
						$hotelOption = "SELECT DISTINCT Hotel_City from hotel_info ";

						$hotelOptionRs = mysqli_query($con,$hotelOption);

					 	while ($hotelOptionRows = mysqli_fetch_array($hotelOptionRs)) {

					 ?>
						<option value="<?php echo $hotelOptionRows['Hotel_City']; ?>"><?php echo $hotelOptionRows['Hotel_City']; ?></option>
	...
	<div class="package">
		...
		<h6 class="detail">Age is no barrier when it comes to travel.</h6>
...
?>
	...
	<div class="top-destination">
		...
		<h6 class="detail">Top Destination in India where You can go with Your Family...</h6>
		<hr>
		<div class="boxes">
			<div class="box">
	...
	<div class="total-tours">
		...
		<h6 class="total-tours-detail">Till now we have arranged 113 Tours and counting.</h6>
		...
		<div class="total-tour-grid">
			<div class="first">
	      		...
	      		<img src="total_tours/total_tours4.jpeg">
