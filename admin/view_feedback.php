                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Feeback</li>
                                        </ul>
                                    </div>
                            ...
                            <div class="col-lg-18" style="width: 100%; padding: 2%;">
                                <div class="table-responsive table--no-card m-b-30">
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                            <?php
                                                while($feed_detail_data = mysqli_fetch_array($feed_detail_rs)){
                                             ?>
                                        <form method="post" id="allUser" action="del_user.php">
                                            <tr>
                                                <!-- <input type="hidden" name = "userid" value="<?php //echo $user_detail_data['Id']; ?>"> -->
                                                <td><?php echo $feed_detail_data['Name'];?></td>
                                                <td><?php echo $feed_detail_data['Email'];?></td>
                                                <td><?php echo $feed_detail_data['Message'];?></td>
                                            </tr>
