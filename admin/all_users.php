                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">All Users</li>
                                        </ul>
                                    </div>
                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <form method="post" id="allUser" action="del_user.php">
                                            <tr>
                                                ...
                                                <td><a href="del_user.php?userid=<?php echo $user_detail_data['Id']; ?>"><span class="badge badge-danger" name="delUser" style="cursor:pointer;"><i class="fa fa-trash"></i></span></a></td>
                                            </tr>
