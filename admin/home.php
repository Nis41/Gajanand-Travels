                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item">
                                    <h2 class="number"><?php  echo $_SESSION['views']; ?></h2>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item">
                                    <h2 class="number"><?php echo $user_count_rows; ?> </h2>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item">
                                    <h2 class="number">&#8377;<?php echo $tot_earning ?></h2>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item">
                                    <h2 class="number"><?php echo $feedback_count_rows; ?></h2>
                                    <span class="desc">Total Feedbacks</span>
                                    <div class="icon">
                            ...
                            <div class="col-lg-18" style="width: 100%; padding: 2%; ">
                                <div class="table-responsive table--no-card m-b-30">
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                            <?php
                                                while($user_detail_data = mysqli_fetch_array($user_detail_rs)){
                                             ?>
                                        <form method="post">
                                            <tr>
                                                <input type="hidden" name = "userid" value="<?php echo $user_detail_data['Id']; ?>">
                                                <td><?php echo $user_detail_data['First_Name'];?></td>
                                                <td><?php echo $user_detail_data['Last_Name'];?></td>
                                                <td><?php echo $user_detail_data['Email'];?></td>
                                                <td><?php echo $user_detail_data['Number'];?></td>
                                                <td><span class="badge badge-danger" name="delUser" style="cursor:pointer;"><i class="fa fa-trash"></i></span></td>
                                            </tr>
                                        </form>
                                            <?php
