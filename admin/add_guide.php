                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Add Guide</li>
                                        </ul>
                                    </div>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="" name="guideName" required>
                        <!-- <span class="bmd-help">We'll never share your email with anyone else.</span> -->
                      </div>
                        <div class="form-group">
                        <label for="" class="bmd-label-floating">Guide State</label>
                        <input type="text" class="form-control" id="" name="guideState" required>
                        <!-- <span class="bmd-help">We'll never share your email with anyone else.</span> -->
                      </div>

                      <div class="form-group">
                        <label for="" class="bmd-label-floating">Guide Detail</label>
                        <textarea class="form-control" id="" rows="4" name="guideDetail" required></textarea>
                      </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control-file" id="" name="guideImage" placeholder="hey"  required>
                            <!-- <small class="text-muted">This is some placeholder block-level help text for the above input. It's a bit lighter and easily wraps to a new line.</small> -->
                        </div>

                        <div class="card-footer">
                                <button type="submit" class="btn btn-primary btn-sm" name="addGuide">
