...
session_start();
    ...
    $edit_guide = "SELECT * from tour_guide where Guide_Id = $gid ";

    $edit_guide_rs = mysqli_query($con,$edit_guide);

    $edit_guide_data = mysqli_fetch_array($edit_guide_rs);
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Edit Guide</li>
                                        </ul>
                                    </div>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                      ...
                      <div class="form-group">
                        <label for="" class="bmd-label-floating">Guide Name</label>
                        <input type="text" class="form-control" id="" name="guideName" value="<?php echo $edit_guide_data['Guide_Name']; ?>" required>
                        <!-- <span class="bmd-help">We'll never share your email with anyone else.</span> -->
                      </div>
                        <div class="form-group">
                        <label for="" class="bmd-label-floating">Guide State</label>
                        <input type="text" class="form-control" id="" name="guideState" value="<?php echo $edit_guide_data['Guide_State']; ?>" required>
                        <!-- <span class="bmd-help">We'll never share your email with anyone else.</span> -->
                      </div>

                      <div class="form-group">
                        <label for="" class="bmd-label-floating">Guide Detail</label>
                        <textarea class="form-control" id="" rows="4" name="guideDetail" required><?php echo $edit_guide_data['Guide_Detail']; ?></textarea>
                      </div>


                        <div class="card-footer">
                                <button type="submit" class="btn btn-primary btn-sm" name="editGuide">
