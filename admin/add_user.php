                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="all_packages.php">
                                        <i class="fas fa-archway"></i>All Packages</a>
                                </li>
                                <li>
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="all_hotels.php">
                                        <i class="fas fa-hotel"></i>All Hotels</a>
                                </li>
                                <li>
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="all_guides.php">
                                        <i class="zmdi zmdi-face"></i>All Guides</a>
                                </li>
                                <li>
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Add User</li>
                                        </ul>
                                    </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <span class="two-box-desc">
                            ...
                            <div class="col-lg-18" style="width: 100%; padding: 2%;">
                                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" style="padding-bottom:2%;">
                      ...
                      <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="" name="userPassword" required>
                        <!-- <span class="bmd-help">We'll never share your email with anyone else.</span> -->
                      </div>
                      <div class="form-group">
                        <label for="" class="bmd-label-floating">Phone</label>
                        <input type="text" class="form-control" id="" name="userPhone" required>
                        <!-- <span class="bmd-help">We'll never share your email with anyone else.</span> -->
                      </div>
