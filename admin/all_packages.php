                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">All Packages</li>
                                        </ul>
                                    </div>
                            ...
                            <div class="col-lg-18" style="width: 100%; padding: 2%;">
                                <div class="table-responsive table--no-card m-b-30">
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                    <?php
                                        while($package_info_data = mysqli_fetch_array($package_info_rs)){
                                            $endDate = $package_info_data['End'];
                                            $current = date("Y-m-d");
                                    ?>
                                           <tr>
                                     <!-- <td><img src="<?php //echo $package_info_data['Image'];?>"></td> -->
                                    <td><?php echo $package_info_data['Package_Name'];?></td>
                                 <td><?php echo $package_info_data['State'];?></td>
                                 <td><?php echo $package_info_data['Start'];?></td>
                              <td>  <?php echo $package_info_data['End'];?>  </td>
                              <td>  <?php echo $package_info_data['Price'];?>  </td>
                              
                              <td><a href="edit_package.php?packageid=<?php echo $package_info_data['Package_Id']; ?>"><span class="badge badge-success" style="cursor:pointer;" ><i class="fa fa-pencil-square-o"></i></span></a></td>
                                <td><a href="del_package.php?packageid=<?php echo $package_info_data['Package_Id']; ?>"><span class="badge badge-danger" style="cursor:pointer;"><i class="fa fa-trash"></i></span></a></td>
