                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">All Guides</li>
                                        </ul>
                                    </div>
                             ...
                             <tr>
                                    ...
                                    <tbody>
                                        <?php
                                         ...
                                         ?>
                                        <tr>
                                            <!-- <td><img src="<?php //echo $guide_detail_data['Guide_Image'] ;?>" alt="" height="70px" width="70px"?></td> -->
                                            <td><?php echo $guide_detail_data['Guide_Name'];?></td>
                                            <td style="max-width: 100px; overflow-x: scroll;"><?php echo $guide_detail_data['Guide_Detail'];?></td>
                                            <td><a href="edit_guide.php?guideid=<?php echo $guide_detail_data['Guide_Id']; ?>"><span class="badge badge-success" style="cursor:pointer;" ><i class="fa fa-pencil-square-o"></i></span></a></td>
                                            <td><a href="del_guide.php?guideid=<?php echo $guide_detail_data['Guide_Id']; ?>"><span class="badge badge-danger" style="cursor:pointer;"><i class="fa fa-trash"></i></span></a></td>
                                        </tr>
