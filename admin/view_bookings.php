                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Bookings</li>
                                        </ul>
                                    </div>
                            ...
                            <div class="col-lg-18" style="width: 100%; padding: 2%;">
                                <div class="table-responsive table--no-card m-b-30">
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                            <?php
                                                while($booking_detail_data = mysqli_fetch_array($booking_detail_rs)){
                                             ?>
                                        <form method="post" id="allUser" action="del_user.php">
                                            <tr>
                                                <!-- <input type="hidden" name = "userid" value="<?php //echo $user_detail_data['Id']; ?>"> -->
                                                <td><?php echo $booking_detail_data['Email'];?></td>
                                                <td><?php echo $booking_detail_data['Package_Name'];?></td>
                                                <td><?php echo $booking_detail_data['Hotel_Name'];?></td>
                                                <td><?php echo $booking_detail_data['Person'];?></td>
                                                <td><?php echo $booking_detail_data['Room'];?></td>
                                                <td><?php echo $booking_detail_data['Total_Price'];?></td>
                                                <td><?php echo $booking_detail_data['Booking_Date'];?></td>

                                                <?php 

                                                    if($booking_detail_data['Status'] == 'Pending') {

                                                 ?>

                                                <td><span class="badge badge-danger" style="cursor:pointer;">Pending</span></td>
                                                ...
                                                <td><span class="badge badge-success" style="cursor:pointer;">Confirm</span></td>
