                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Add Package</li>
                                        </ul>
                                    </div>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="" name="tourName" required>
                        
                      </div>

                        <div class="form-group">
                        <label for="" class="bmd-label-floating">State</label>
                        <input type="text" class="form-control" id="" name="packageState" required>
                      </div>

                        <div class="form-group">
                        <label for="" class="bmd-label-floating">City</label>
                        <input type="text" class="form-control" id="" name="packageCity" required>
                      </div>
                        ...
                        <input type="date" class="form-control" id="" name="endDate" required>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="" rows="4" name="tourDetail" required></textarea>
                      </div>

                        <div class="form-group">
                        <label for="" class="bmd-label-floating">Map Link</label>
                        <input type="text" class="form-control" id="" name="map" required>
                      </div>

                        <div class="form-group">
                            <label for="" class="bmd-label-floating">Images</label>
                            <input type="file" class="form-control-file" id="" name="image[]" placeholder="hey" multiple required>
                            <!-- <small class="text-muted">This is some placeholder block-level help text for the above input. It's a bit lighter and easily wraps to a new line.</small> -->

                        </div>
                        
                        <div class="card-footer">
                                <button type="submit" class="btn btn-primary btn-sm" name="addPackage">
